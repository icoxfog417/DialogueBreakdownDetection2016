...
class TestSeq2SeqByDbdData(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../data/dialog_log/2015/development"))
        cls.TARGET_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../data/analyzed_data"))
        cls.TARGET_DIR = os.path.abspath(os.path.dirname(cls.TARGET_PATH))
